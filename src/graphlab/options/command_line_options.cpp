...
bool command_line_options::parse(int argc, const char* const* argv,
  ...
  if (!suppress_graphlab_options) {
    ...
    desc.add_options()(
        ...
        "engine_help", boost_po::value<std::string>()->implicit_value(""),
        "Display help for engine options.")(
        "graph_help", boost_po::value<std::string>()->implicit_value(""),
        "Display help for the distributed graph.")(
        "scheduler_help", boost_po::value<std::string>()->implicit_value(""),
  ...
  try {
    ...
    if (allow_unregistered) {
      unrecognized_options = boost_po::collect_unrecognized(
