 ...
 * <i>Misra, J.: Detecting Termination of Distributed Computations Using
 * Markers, SIGOPS, 1983</i> extended to handle the mixed parallelism
 * (distributed with threading) case.
 *
...
class fiber_async_consensus {
 public:
   ...
   *               the global context.
   */
  fiber_async_consensus(distributed_control &dc,
                        size_t required_fibers_in_done = 1,
