...
circular_char_buffer& circular_char_buffer::operator=(
...
std::streamsize circular_char_buffer::read(char* c, std::streamsize clen) {
  if (len == 0) return -1;
...
circular_char_buffer::~circular_char_buffer() { free(buffer); }
