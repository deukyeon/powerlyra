...
class jni_core : public java_any {
 ...
 public:
  ...
  static void throw_exception(JNIEnv *env, const char *exception,
                              const char *message) {
