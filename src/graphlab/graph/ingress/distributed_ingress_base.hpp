...
#pragma omp parallel
    ...
    void print_network_statistics() {
      ...
      logstream(LOG_INFO) << rpc.procid() << " Bytes Sent(Ingress): " << rpc.dc().bytes_sent() << std::endl;
      logstream(LOG_INFO) << rpc.procid() << " Calls Sent(Ingress): " << rpc.dc().calls_sent() << std::endl;
      logstream(LOG_INFO) << rpc.procid() << " Network Sent(Ingress): " << rpc.dc().network_bytes_sent() << std::endl;
      logstream(LOG_INFO) << rpc.procid() << " Bytes Received(Ingress): " << rpc.dc().bytes_received() << std::endl;
      logstream(LOG_INFO) << rpc.procid() << " Calls Received(Ingress): " << rpc.dc().calls_received() << std::endl;
      ...
      oss.str();
      logstream(LOG_INFO) << rpc.procid() << " Bytes Sent Vector(Ingress): "
      << oss.str() << std::endl;
    }
