...
template <typename valuetype,
          uint32_t capacity = (4096 - 20) / sizeof(valuetype)>
class dynamic_block {
 public:
  ...
  void split() {
    ...
    memcpy(secondhalf->values, &values[mid],
           (capacity / 2) * sizeof(valuetype));
    // update pointer
  ...
  dynamic_block* next() { return _next; }
