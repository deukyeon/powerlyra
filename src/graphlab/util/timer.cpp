...
void alarm_wakeup(int i) {
  ...
  // compute the desired time till the next 100ms tick by using a real timer
  // call
 ...
 */
float timer::approx_time_seconds() { return float(hmstimer.ctr) / 10; }

/**
 * Precision of deciseconds
 */
size_t timer::approx_time_millis() { return hmstimer.ctr * 100; }
