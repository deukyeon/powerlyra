...
int test_function_is_const_ref(T t) {
  return graphlab::test_function_or_const_functor_1<
      T, void(const ts&), /* function form*/
      void,               /* return type */
      const ts&           /* argument 1 */
      >::value;
}
...
int main(int argc, char** argv) {
  ...
  std::cout << test_function_is_const_ref(functor_by_const_value())
            << std::endl;
  std::cout << test_function_is_const_ref(functor_by_reference()) << std::endl;
  std::cout << test_function_is_const_ref(functor_by_const_reference())
            << std::endl;

  std::cout << test_function_is_const_ref(const_functor_by_value())
            << std::endl;
  std::cout << test_function_is_const_ref(const_functor_by_const_value())
            << std::endl;
  std::cout << test_function_is_const_ref(const_functor_by_reference())
            << std::endl;
  std::cout << test_function_is_const_ref(const_functor_by_const_reference())
            << std::endl;

  std::cout << test_function_is_const_ref(overload_functor_by_value())
            << std::endl;
  std::cout << test_function_is_const_ref(overload_functor_by_const_value())
            << std::endl;
  std::cout << test_function_is_const_ref(overload_functor_by_reference())
            << std::endl;
  std::cout << test_function_is_const_ref(overload_functor_by_const_reference())
            << std::endl;
}