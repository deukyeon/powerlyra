...
void test_in_neighbors(graphlab::distributed_control& dc,
                       ...
                       graph_type& graph) {
  std::cout << "Constructing a syncrhonous engine for in neighbors"
            << std::endl;
...
void test_out_neighbors(graphlab::distributed_control& dc,
                        graphlab::command_line_options& clopts,
                        graph_type& graph) {
  std::cout << "Constructing a syncrhonous engine for out neighbors"
            << std::endl;
...
class count_all_neighbors : public graphlab::ivertex_program<graph_type, int>,
                            public graphlab::IS_POD_TYPE {
 public:
  edge_dir_type gather_edges(icontext_type& context,
                             const vertex_type& vertex) const {
...
void test_all_neighbors(graphlab::distributed_control& dc,
                        graphlab::command_line_options& clopts,
                        graph_type& graph) {
  std::cout << "Constructing a syncrhonous engine for all neighbors"
            << std::endl;
...
class basic_messages : public graphlab::ivertex_program<graph_type, int, int>,
                       public graphlab::IS_POD_TYPE {
  int message_value;
...
void test_messages(graphlab::distributed_control& dc,
                   graphlab::command_line_options& clopts, graph_type& graph) {
...
class count_aggregators : public graphlab::ivertex_program<graph_type, int>,
                          public graphlab::IS_POD_TYPE {
 public:
  edge_dir_type gather_edges(icontext_type& context,
                             const vertex_type& vertex) const {
...
void test_count_aggregators(graphlab::distributed_control& dc,
  ...
  engine_type engine(dc, graph, clopts);
  engine.add_vertex_aggregator<int>("iteration_counter", iteration_counter,
                                    iteration_finalize);
