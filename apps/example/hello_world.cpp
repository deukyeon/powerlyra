...
class concomp : public graphlab::ivertex_program<graph_type, float>,
 ...
 public:
  float gather(icontext_type& context, const vertex_type& vertex,
    ...
    std::cout << "current vertex id: " << vertex.id()
              << " data: " << vertex.data() << "\n";

    std::cout << "\tedge vertex id: " << edge.source().id()
              << " data: " << edge_data << "\n";
