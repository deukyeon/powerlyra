 ...
 * algorithm. As described in:  Collaborative Filtering for Implicit Feedback
 * Datasets Hu, Y.; Koren, Y.; Volinsky, C. IEEE International Conference on
...
int main(int argc, char** argv) {
  ...
  //                      "Renumber target vertex ids (internally) so that
  //                      they\n" "are in a different range allowing user 0 to
  //                      connect to movie 0");
