...
dense_table_t create_rand_dense_table(unsigned v0_id, unsigned v1_id,
                                      unsigned v2_id) {
...
void testDataReorder(unsigned v0_id, unsigned v1_id, unsigned v2_id) {
  ...
  // std::cout << "v0_id " << v0_id << " v1_id " << v1_id << " v2_id " << v2_id
  // << std::endl;
...
dense_table_t create_dense_table(unsigned v0_id, unsigned v1_id,
                                 unsigned v2_id) {
