...
std::vector<double> compute_labels(size_t n_labels, double max_range,
                                   double min_range);
...
int main(int argc, char** argv) {
  ...
  std::vector<double> d_labels =
      compute_labels(2 * n_labels, max_range, min_range);
  ...
  std::cout << "d: " << d << " d_prime: " << d_prime << " err: " << err
            << std::endl;
