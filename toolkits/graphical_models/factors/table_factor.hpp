...
/**
 * This file defines an opaque interface (or facade) for the various table
 * types.
 *
...
class table_factor {
 ...
 private:
  ...
  void alloc() { alloc_table(_table_storage, &(this->_table)); }
  ...
  void alloc_table(table_storage_t storage, table_base_t** base) {
    ...
    switch (storage) {
      ...
      default:
        // i allow *this to be constructed with a table_factor::nil table
        // storage type, so this path is possible
        break;
    }
  }
 ...
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out,
    ...
    out << "Table Factor(" << factor._table_storage
        << "): " << *(factor._table);
    return out;
  }
