...
struct generic_apply : public apply_functor {
  ApplyType* at;
  bool operator()(vars& center, const var& gather_result) {
...
struct generic_scatter_select : public scatter_select_functor {
  ...
  edge_dir_type operator()(const vars& center) { return (*st)(center); }
};

template <typename ScatterType>
struct generic_scatter : public scatter_functor {
  ScatterType* st;
  bool operator()(const vars& center, vars& edge, const vars& other,
                  edge_direction direction) {
