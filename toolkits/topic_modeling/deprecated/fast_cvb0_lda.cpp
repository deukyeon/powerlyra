...
int main(int argc, char** argv) {
  ...
  const std::string description =
      ...
      "\t./fast_cvb0_lda --dictionary dictionary.txt --matrix "
      "doc_word_count.tsv\n"
  ...
  ASSERT_TRUE(success);
  success = engine.add_vertex_aggregator<factor_type>(
                "global_counts", global_counts_agg::map,
                global_counts_agg::finalize) &&
