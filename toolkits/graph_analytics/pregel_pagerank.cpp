 ...
 * representation.  If a vertex program does not exted      std::cout <<
 "Iteration: " << context.iteration() << std::endl;
...
class pagerank : public graphlab::ivertex_program<graph_type, graphlab::empty,
 ...
 public:
  ...
  edge_dir_type scatter_edges(icontext_type& context,
                              const vertex_type& vertex) const {
    // if (last_change > TOLERANCE || context.iteration() == 0) return
    // graphlab::OUT_EDGES; else return graphlab::NO_EDGES;
